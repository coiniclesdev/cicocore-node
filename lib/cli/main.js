...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `cicocore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ cicocore-node add wallet-service');
      console.log('    $ cicocore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ cicocore-node remove wallet-service');
      console.log('    $ cicocore-node remove insight-api');
      console.log();
    });
