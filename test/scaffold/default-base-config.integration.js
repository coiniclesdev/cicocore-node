...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    cicod.spawn.datadir.should.equal(home + '/.cico');
    cicod.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/cicod'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.cicod.spawn.datadir.should.equal('./data2');
  });
});
